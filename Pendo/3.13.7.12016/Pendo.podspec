Pod::Spec.new do |s|
  ...
  s.source              = { :http => 'https://software.mobile.pendo.io/artifactory/ios-sdk-beta/3.13.7.12016/pendo-ios-sdk-xcframework.3.13.7.12016.beta.zip' }
  s.requires_arc = true
