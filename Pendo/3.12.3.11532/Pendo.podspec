Pod::Spec.new do |s|
  ...
  s.source              = { :http => 'https://software.mobile.pendo.io/artifactory/ios-sdk-beta/3.12.3.11532/pendo-ios-sdk-xcframework.3.12.3.11532.beta.zip' }
  s.requires_arc = true
