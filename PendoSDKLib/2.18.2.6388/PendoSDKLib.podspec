Pod::Spec.new do |s|
  ...
  s.source                  = { :http => 'https://software.mobile.pendo.io/artifactory/ios-sdk-beta/2.18.2.6388/pendo-ios-sdk-static-libraries.2.18.2.6388.APP-68838-guide-crash-on-next-step-with-screen-data-nil.zip' }
